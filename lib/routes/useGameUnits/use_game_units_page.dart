...
class UseGameUnitsPage extends StatefulWidget {
  @override
  _UseGameUnitsPage createState() => _UseGameUnitsPage();
}

class _UseGameUnitsPage extends State<UseGameUnitsPage> {
  bool allowVal = false;
  bool blockVal = true;
  bool wedVal = false;
  final FocusNode _focusNode = FocusNode();
  String firstTextValue = "";
  String firstText = 'USE GAME UNITS   • ';
  String secondText = ' Have 100  |  Need 110';
    ...
    _focusNode.addListener(() {
      ...
      if (!_focusNode.hasFocus) {
        if (firstTextValue.isEmpty) {
          setState(() {
            firstText = 'USE GAME UNITS   • ';
            secondText = ' Have 100  |  Need 110';
          });
        }
...
//                                    )
                                ...
                                Padding(
                                  padding: EdgeInsets.fromLTRB(18, 15, 38, 15),
...
//                                    )
                                ...
                                hintText: 'ENTER GAME UNITS NUMBER',
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Text(
                            "Sorry, your Game Units have not been "
                            "verified, perhaps you have entered your Unit "
                            "Code or Barcode incorrectly. Please try again, "
                            "if this persists please contact the Game Masters"
                            " by clicking here\n\nSorry, you do not have enough "
                            "Game Units, please buy more Game Units, or Get"
                            " Game Units by entering in your Unit Code or "
                            "Barcode above.",
                            style: TextStyle(
