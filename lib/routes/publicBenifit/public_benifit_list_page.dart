...
import 'public_benefit_details.dart';
...
class PublicBenifitsListPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return PublicBenifitsListPageState();
  }
}

class PublicBenifitsListPageState extends State<PublicBenifitsListPage> {
  @override
          ...
          child: Container(
            child: Column(children: <Widget>[
              ...
              Padding(
                ...
                child: AutoSizeText(
                  "PAST SFTs & PUBLIC BENEFITS | LIST",
  ...
  _box() {
    return GestureDetector(
      child: Container(
        padding: const EdgeInsets.only(top: 16.0, left: 16, bottom: 16, right: 15),
        child: Column(
      ...
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => PublicBenefitDetailsPage()));
      },
    );
  }
