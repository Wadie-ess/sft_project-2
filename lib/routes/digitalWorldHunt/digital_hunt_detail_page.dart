...
class DigitalHuntDetailPage extends StatefulWidget {
  final indexClicked;

  const DigitalHuntDetailPage({Key key, this.indexClicked}) : super(key: key);
  @override
  _DigitalHuntDetailPage createState() => _DigitalHuntDetailPage();
}

class _DigitalHuntDetailPage extends State<DigitalHuntDetailPage> {
  bool allowVal = false;
  bool blockVal = true;
  bool wedVal = false;
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => PrizeDetailPage(
                                  indexClicked: widget.indexClicked,
                                )),
                      )
                    },
                    child: Container(
