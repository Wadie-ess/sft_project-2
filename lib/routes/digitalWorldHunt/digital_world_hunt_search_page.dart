...
import 'digital_hunt_detail_page.dart';

class DigitalWorldHuntSearchPage extends StatefulWidget {
  @override
  _DigitalWorldHuntSearchPage createState() => _DigitalWorldHuntSearchPage();
}

class _DigitalWorldHuntSearchPage extends State<DigitalWorldHuntSearchPage> {
  bool allowVal = false;
  bool blockVal = true;
  bool wedVal = false;
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(
                        child: Text(
                            "Sorry, there are currently no Digital World"
                            " Hunts launched from the area you searched. or"
                            " There are currently x26 Digital World Hunts "
                            "launched from the area you searched, please see "
                            "below. However, the x9 Digital World Hunts launched"
                            " closest to your search are listed below. If you "
                            "do not want to play in the Digital World Hunts "
                            "below, close this window to return to the previous"
                            " Hunt list.\nDigital World Hunts are sometimes "
                            "launched from different countries, but all Digital"
                            " World Hunts are available for everyone from any"
                            " country to play in.",
                            style: TextStyle(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return GestureDetector(
                          onTap: () => {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => DigitalHuntDetailPage()),
                            )
                          },
                          child: Container(
                            decoration: BoxDecoration(
