...
import 'sft_details_page.dart';

class MySFTsPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return MySFTsPageState();
  }
}

class MySFTsPageState extends State<MySFTsPage> {
  @override
  ...
  _box() {
    return InkWell(
      ...
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => SFTDetailsPage()));
      },
    );
  }
