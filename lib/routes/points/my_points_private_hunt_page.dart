...
class MyPointsPrivateHuntWPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return MyPointsPrivateHuntWPageState();
  }
}

class MyPointsPrivateHuntWPageState extends State<MyPointsPrivateHuntWPage> {
  @override
