...
class MyPointsDigitalWLBPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return MyPointsDigitalWLBPageState();
  }
}

class MyPointsDigitalWLBPageState extends State<MyPointsDigitalWLBPage> {
  @override
        ...
        body: SingleChildScrollView(
          ...
          child: Container(
            child: Column(children: <Widget>[
              SizedBox(height: 20),
              AutoSizeText(
                "DIGITAL WORLD LEADERBOARD | 2019",
