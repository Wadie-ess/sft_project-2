...
import 'secret_number_processing_page.dart';
import '../../utils/AppBarMain.dart';
import '../../utils/CustomDrawer.dart';
import 'package:flutter/material.dart';
import '../main/choose_hunt_page.dart';

class ThirdAnswerPage extends StatefulWidget {
  @override
  _ThirdAnswerPage createState() => _ThirdAnswerPage();
}

class _ThirdAnswerPage extends State<ThirdAnswerPage> {
  bool allowVal = false;
  bool blockVal = true;
  bool wedVal = false;
  final FocusNode _focusNode = FocusNode();
  String firstTextValue = "";
  String firstText = 'ENTER THIRD ANSWER TO FIND THE CHOOHOO NOW';
    ...
    _focusNode.addListener(() {
      ...
      if (!_focusNode.hasFocus) {
        if (firstTextValue.isEmpty) {
          setState(() {
            firstText = 'ENTER THIRD ANSWER TO FIND THE CHOOHOO NOW';
          });
        }
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: Text("This Hunt requires a third answer. ",
                            style: TextStyle(
                                fontFamily: 'Roboto', color: Color.fromRGBO(180, 179, 180, 1), fontSize: 14, fontWeight: FontWeight.w400)),
                      ),
                    ],
                                      ...
                                      decoration: InputDecoration(
                                        suffixIcon: IconButton(
                                          ...
                                          onPressed: () => {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(builder: (context) => SecretNumberProcessingPage()),
                                            )
                                          },
                                        ),
