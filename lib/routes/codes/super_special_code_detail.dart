...
class SuperSpecialCodeDetail extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return SuperSpecialCodeDetailState();
  }
}

class SuperSpecialCodeDetailState extends State<SuperSpecialCodeDetail> {
  @override
        ...
        child: Container(
          ...
          child: Container(
            ...
            child: Column(children: <Widget>[
              SizedBox(height: 20),
              AutoSizeText(
                Localization.stLocalized("superSpecialCodeDetails").toUpperCase(),
          ...
          Row(
            children: <Widget>[
              Padding(
                ...
                child: SvgPicture.asset("assets/svg-icons/super_special_icon.svg", width: 90, height: 90),
                
                
                //Image.asset("assets/images/triangle/triangle_super_special.png", width: 90, height: 90),
              ),
              Expanded(
                child: Padding(
